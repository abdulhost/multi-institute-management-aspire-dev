  ...
  <ul class="sub-menu <?php echo $active_section == 'subscription' || $active_section == 'add-department' || $active_section == 'edit-department' || $active_section == 'delete-department' ? 'show' : ''; ?>">
    ...
    <li>
      ...
      <ul class="sub-menu <?php echo $active_section == 'add-students' || $active_section == 'edit-students' ? 'show' : ''; ?>">
        <div>
          <li class="<?php echo $active_section == 'students' ? 'active' : ''; ?>"><a href="/institute-dashboard?section=students">Students</a></li>
          <li class="<?php echo $active_section == 'add-students' ? 'active' : ''; ?>"><a href="/institute-dashboard?section=add-students">Add Students</a></li>
          <li class="<?php echo $active_section == 'edit-students' ? 'active' : ''; ?>"><a href="/institute-dashboard?section=edit-students">Edit Students</a></li>
        </div>
      </ul>
    </li>
    <li>

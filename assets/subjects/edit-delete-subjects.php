...
function handle_subject_actions() {
    global $wpdb;
...
function render_subjects_list($educational_center_id) {
    global $wpdb;
    $table_name = $wpdb->prefix . 'subjects';
...
// Main page rendering
function subjects_manager_page() {
    $message = handle_subject_actions();
    $educational_center_id = get_educational_center_data();
    ?>
    ...
    <div class="wrap subjects-manager">
        ...
        <div class="card subjects-card">
            ...
            <?php render_subjects_list($educational_center_id); ?>
        </div>
    </div>
    </div>

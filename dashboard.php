            ...
            <div class="main-content">
                ...
                switch ($section) {
                    ...
                    case 'subscription':
                        ...
                        break;
                    case 'students':                        error_log("Default case triggered, rendering students wi: ");

                        if ($action === 'add-students') {
                            echo add_students_institute_dashboard_shortcode($educational_center);
                        } elseif ($action === 'edit-students') {
                            echo edit_students_institute_dashboard_shortcode($educational_center);
                        } else {
                        error_log("Default case triggered, rendering students wi: ");

                            echo students_institute_dashboard_shortcode($educational_center);
                        }
                        break;
                    
                    default:
                        error_log("Default case triggered, rendering dashboard with Educational Center:section= ". $section ."next n");
                        echo render_institute_dashboard($current_user, $educational_center);
                        break;
                }
                ?>
